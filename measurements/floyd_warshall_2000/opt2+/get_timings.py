...
filenames = os.listdir('/home/sarahtr/dace/measurements/floyd_warshall_2000/opt2+')
filenames.remove("get_timings.py")
filenames.remove("v++_kernel_0_0_hw.log")
...
for file in filenames:
    path_file = '/home/sarahtr/dace/measurements/floyd_warshall_2000/opt2+/' + file
