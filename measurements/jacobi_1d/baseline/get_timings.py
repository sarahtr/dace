...
filenames = os.listdir('/home/sarahtr/dace/measurements/jacobi_1d/baseline')
filenames.remove("get_timings.py")
filenames.remove("v++_jacobi_1d_kernel_0_0_hw.log")
print(filenames)
state = []
kernel = []

for file in filenames:
    path_file = '/home/sarahtr/dace/measurements/jacobi_1d/baseline/' + file
